...
subprocess.call("(sudo mv /home/pi/temp/bin/Config /var/www/html/)", shell=True)
subprocess.call("(sudo mv /home/pi/temp/bin/index.php /var/www/html/index.php)", shell=True)
